            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php if(!isset($_GET['newwindow'])) { ?>
                        ...
                        <p><a href="#" onclick="window.open('<?php echo actionurl('/schedules/boardingpass/'.$schedule->id.'?newwindow');?>'); return false;">Open in new window for printing</a></p>
                    <?php } ?>
